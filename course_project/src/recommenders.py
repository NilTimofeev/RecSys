...
class MainRecommender:
    ...
    @staticmethod
    def fit(user_item_matrix, n_factors=20, regularization=0.1, iterations=30, num_threads=-1):
        """Обучает ALS"""
    ...
    def get_own_recommendations(self, user, N=5):
        ...
        self._update_dict(user_id=user)
        return self._get_recommendations(user, model=self.own_recommender, N=N-1)
